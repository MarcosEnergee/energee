...
function renderiza_grafico_relatorio(url){
    ...
    fetch(url, {
        ...
        const ctx = document.getElementById('grafico_relatorio').getContext('2d');
        var cores_grafico_relatorio = gera_cor(qtd=12)
        const myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: data.labels,
                    data: data.data,
                    backgroundColor: cores_grafico_relatorio[0],
                    borderColor: cores_grafico_relatorio[1],
                    borderWidth: 1
                }]
            },
            options: {
